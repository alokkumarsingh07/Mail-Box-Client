...
const SignUp = () => {
  ...
  const endPointUrl = signIn
    ? `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBWkRZOxr4iAbG1F01BOx3rtyz2HisN3C0`
    : `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBWkRZOxr4iAbG1F01BOx3rtyz2HisN3C0`;
