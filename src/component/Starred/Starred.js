...
const Starred = () => {
  ...
  const url1 = `https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/emails`;
  const url2 = `https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/sent-emails/${senderMail}`;
