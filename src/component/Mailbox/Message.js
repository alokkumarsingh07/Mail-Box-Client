...
const Message = () => {
  ...
  if (mails.length > 0) {
    url =
      mail.sender === email
        ? `https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/sent-emails/${senderMail}/${mail.id}.json`
        : `https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/emails/${mail.id}.json`;
  }
