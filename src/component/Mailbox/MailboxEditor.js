...
const MailboxEditor = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (emailInfo.recipient !== emailInfo.sender) {
      try {
        const url1 =
          "https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/emails.json";
        const url2 = `https://react-mailbox-client-4b847-default-rtdb.firebaseio.com/sent-emails/${email}.json`;
